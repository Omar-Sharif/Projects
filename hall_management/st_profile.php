...
<?php
    ...
    $sql="SELECT * FROM student_info where Username='$user'";
    ...
    if(isset($_POST['update'])){
        ...
        if($ffname==$row['Password'] and $okk){
            ...
            if (in_array($file_ext,$allowed_file_types) && ($filesize < 20000000000)){   
                ...
                $sql = "UPDATE student_info SET Profile_Pic='$newfilename' WHERE Username='$user'";
            ...
            $ffname=$_POST['fname'];
            $sql= "UPDATE student_info SET Fname='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql);
            $ffname=$_POST['lname'];
            $sql="UPDATE student_info SET Lname='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql); 
            $ffname=$_POST['fathername'];
            $sql="UPDATE student_info SET Fat_Name='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql);
            $ffname=$_POST['dptname'];
            $sql="UPDATE student_info SET Dept_Name='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql);  
            $ffname=$_POST['mothername'];
            $sql="UPDATE student_info SET Mot_name='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql); 
            $ffname=$_POST['address'];
            $sql="UPDATE student_info SET Address='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql); 
            $ffname=$_POST['phn'];
            $sql="UPDATE student_info SET Mobile='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql); 
            $ffname=$_POST['gender'];
            $sql="UPDATE student_info SET Gender='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql); 
            $ffname=$_POST['religion'];
            $sql="UPDATE student_info SET Religion='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql); 
            $ffname=$_POST['blood'];
            $sql="UPDATE student_info SET Blood_Group='$ffname' WHERE Username='$user'";
            $rslt=mysqli_query($conn,$sql);
            if(strlen($new_password)>4){
                $sql="UPDATE student_info SET Password='$new_password' WHERE Username='$user'";
                $rslt=mysqli_query($conn,$sql);
            }
    ...
    <div class="w3-row w3-khaki">
        ...
        <div class="w3-col w3-container" style="width:85%;text-align: center; background-image: url(images/back6.jpg);">
                <div class="w3-col w3-container" style="width:100%;">
                    <center>
                        <div class="container" style="text-align: center; background-image: url(images/back6.jpg);">
                            ...
                            <form id="html5Form"  class="form-horizontal" role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group" style="text-align: right;">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" maxlength="20" class="form-control" id="stid" name="stid" value="<?php echo $row['StID']?>" disabled>
                                    </div>
                                </div><br>
                                ...
                                <div class="form-group" style="text-align: right;">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" maxlength="30" pattern="[a-zA-Z ]+" class="form-control" id="dptname" name="dptname" value="<?php echo $row['Dept_Name']?>" placeholder="Enter Department Name" s>
                                    </div>
                                </div><br>
                                ...
                                <div class="form-group" style="text-align: right;">
                                    ...
                                    <div class="col-sm-4 ">
                                        <input type="text" maxlength="30" pattern="[a-zA-Z ,.-]+" class="form-control" id="address" name="address" value="<?php echo $row['Address']?>" placeholder="Upazila, Zila, Postal Code" >
                                    </div>
                                </div><br>
                                ...
                                <div class="form-group" style="text-align: right;">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" maxlength="30" pattern="[a-zA-Z +]+" class="form-control" id="blood" name="blood" value="<?php echo $row['Blood_Group']?>" placeholder="Enter Blood Group">
                                    </div>
                                </div><br>
                                <div class="form-group" style="text-align: right;">
